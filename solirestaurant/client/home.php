...
if (isset($_POST['add_to_cart'])) {
    ...
    session_write_close();
    header("location: home.php#{$idPlat}");
    exit;
}
...
<body>
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links" id="navLinks">
                ...
                <li><a href="panier.php"><i class="fa-solid fa-cart-shopping" style="color: #9E6752;"></i>&nbsp
                        <span>Panier</span></a>
        ...
        <?php foreach ($platsByCuisine as $typeCuisine => $plats): ?>
            ...
            <div class="cuisine-section">
                <?php foreach ($plats as $plat): ?>
                    ...
                    ?>
                    <div id="<?= htmlspecialchars($plat['idPlat']) ?>" class="card">
                        ...
                        <div class="card-content">
                            ...
                            <?php if ($inCart): ?>
                                <button type="button" id="commande" disabled class="cta">Commandé</button>
                            <?php else: ?>
                                <form method="POST" action="home.php">
                                    <input type="hidden" name="idPlat" value="<?= htmlspecialchars($plat['idPlat']) ?>">
                                    <button type="submit" name="add_to_cart" class="cta">
                                        <span class="hover-underline-animation">Commander</span>
                                        <svg id="arrow-horizontal" xmlns="http://www.w3.org/2000/svg" width="25" height="10" viewBox="0 0 46 16">
    ...
    <a href="#top" class="upButton"><i class="fa-solid fa-up-long" style="color: white;"></i></a>
